...
import { getFranquicias, getSelectProduct, insertIngreso } from "../db/database";
import {
      ...
      <div style={{ display: "flex", gap: "30px", height: "55px"}}>
        ...
        <div style={{ width: "15%", display: "flex", justifyContent: "center", alignItems: "flex-end", marginBottom: "7px"}}>
          <Button
            ...
            onClick={() => insertIngreso(selectedFranq.id, selectedProduct.id, cantInput.current.value, observacionesInput.current.value)}
          >
            Agregar
          </Button>
        </div>
